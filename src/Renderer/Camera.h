...
public:
    ...
    Mat4 getPerspectiveMatrix(float fov, float aspect, float near, float far) const;
    Mat4 getOrthographicMatrix(float left, float right, float bottom, float top, float near, float far) const;
