...
public:
    ...
    void getOrthographicMatrix(float* matrix, float left, float right, float bottom, float top, float near, float far) const;
    ...
    const Vector3& getFront() const { return front_; }
