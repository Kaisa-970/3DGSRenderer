...
void AssimpModelLoader::processMaterial(aiMaterial* material, const aiScene* scene,const std::string& directory, std::shared_ptr<Material>& outMaterial) {
    aiString name;
    ...
    LOG_CORE_INFO("Diffuse color: {}, {}, {}", outMaterial->getDiffuseColor().x, outMaterial->getDiffuseColor().y, outMaterial->getDiffuseColor().z);
    ...
    LOG_CORE_INFO("Specular color: {}, {}, {}", outMaterial->getSpecularColor().x, outMaterial->getSpecularColor().y, outMaterial->getSpecularColor().z);
    ...
    LOG_CORE_INFO("Ambient color: {}, {}, {}", outMaterial->getAmbientColor().x, outMaterial->getAmbientColor().y, outMaterial->getAmbientColor().z);
    // 镜面反射强度
