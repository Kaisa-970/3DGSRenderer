...
public:
    ...
    void AddTexture2D(const std::string &name, const std::shared_ptr<Renderer::Texture2D> &texture,
    ...
    bool SaveTexture2D(const std::string &path, const std::shared_ptr<Renderer::Texture2D> &texture);
